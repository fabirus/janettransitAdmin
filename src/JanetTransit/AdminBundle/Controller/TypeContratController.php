...
use JanetTransit\AdminBundle\Entity\TypeContrat;
use JanetTransit\AdminBundle\Form\TypeContratType;
...
class TypeContratController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JanetTransitAdminBundle:TypeContrat')->findAll();
     ...
     *
     * @Route("/", name="typecontrat_create")
     * @Method("POST")
     * @Template("JanetTransitAdminBundle:TypeContrat:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JanetTransitAdminBundle:TypeContrat')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="typecontrat_update")
     * @Method("PUT")
     * @Template("JanetTransitAdminBundle:TypeContrat:edit.html.twig")
     */
